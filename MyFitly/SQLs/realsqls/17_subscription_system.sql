...
-- MyFitly Pro aboneliği için entitlements tablosu

-- 1) ENTITLEMENTS TABLOSU - Abonelik durumunu tutar
CREATE TABLE IF NOT EXISTS entitlements (
  user_id UUID PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE,
  product_id TEXT NOT NULL,           -- 'myfitly.pro.monthly'
...
-- INSERT INTO entitlements (user_id, product_id, platform, is_active, expires_at)
-- VALUES ('USER_ID', 'myfitly.pro.monthly', 'ios', TRUE, NOW() + INTERVAL '30 days')
-- ON CONFLICT (user_id) DO UPDATE
