    ...
    return (
      <ScrollView contentContainerStyle={{ padding: spacing.md, paddingBottom: 32 }}>
        ...
        {workoutData.exercises.length > 0 && (
          <Card style={{ marginBottom: spacing.md, backgroundColor: 'rgba(255, 122, 0, 0.05)' }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.sm }}>
              ...
              <View style={{ flex: 1, alignItems: 'center' }}>
                <Text style={{ color: colors.text, fontSize: 14, fontWeight: '700' }}>
                  {weekOffset === 0 ? 'Bu Hafta' : weekOffset === -1 ? 'Geçen Hafta' : weekOffset === 1 ? 'Gelecek Hafta' : `${weekOffset > 0 ? '+' : ''}${weekOffset} Hafta`}
                </Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.xs }}>
              {weekDates.map((dateInfo, index) => {
                ...
                return (
                  ...
                  >
                    <Text style={{ 
                      color: isToday ? colors.background : colors.textMuted,
                      fontSize: 10,
                      fontWeight: '600',
                      marginBottom: 2
                    }}>
                      {weekDays[dateInfo.dayIndex]}
                    </Text>
                    <Text style={{ 
